    ...
    <div name="contact" className="main px-8 md:px-16 lg:px-[12rem]">
      <div className="heading  ">
        ...
        {/* <div className="main_box hidden md:flex flex-wrap gap-6 md:gap-8 lg:gap-12 justify-between items-center pb-6">
          <Link to={'/tech'} ><h1 className='text-red-600 cursor-pointer underline underline-offset-4 decoration-red-600'>Tech Stack</h1></Link>
          <Link to={'/experi'} smooth={true} duration={500} offset={-70} activeClass="active"><h1 className='md:hover:text-red-600 cursor-pointer underline underline-offset-4 hover:decoration-red-600'>Work Experience</h1></Link>
          <Link to={'/intern'} ><h1 className='md:hover:text-red-600 cursor-pointer underline underline-offset-4 hover:decoration-red-600'>Internship Experience</h1></Link>
          <Link to={'/edu'} ><h1 className='md:hover:text-red-600 cursor-pointer underline underline-offset-4 hover:decoration-red-600'>Education</h1></Link>
          <Link to={'/online'}><h1 className='md:hover:text-red-600 cursor-pointer underline underline-offset-4 hover:decoration-red-600'>Online Education</h1></Link>
        </div > */}
        {/* mobile      */}
