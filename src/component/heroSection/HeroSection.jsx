    ...
    <div className='md:h-[41rem] pb-8  flex items-center justify-center'>
      ...
      <div className="main grid grid-cols-1 md:grid-cols-2 lg:gap-28 md:gap-10 px-8 sm:gap-16 ">        
        ...
        <div className="box  md:pt-0 pt-10">
          ...
          <div className='font-bold text-[#dc2626] text-2xl md:text-5xl leading-tight  flex space-x-3'>
            <h1 > I'm  a</h1>
          <ReactTyped  
        ...
        />
          ...
          <div className="social flex items-center  justify-start gap-5 pt-4 md:pt-8">
            ...
            <div className="youtube">
              <Link target='_blank'><button className='rounded-full p-1  cursor-pointer'><FaYoutube className=' text-3xl bg-red-600 text-white  rounded-md' /></button></Link>
            </div>
            <div className="twitter">
              <Link target='_blank'><button className='rounded-full p-1  cursor-pointer'><FaTwitter className=' text-3xl text-blue-900 bg-white  rounded-md' /></button></Link>
            </div>
          </div>
        </div>
      </div>
